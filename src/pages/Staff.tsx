...
const Staff = () => {
	const { staff, searchBy, setSearchTerm, setSearchBy, error, setShowDeleted } =
		useStaff();
...
const RenderTable = ({ staff }: { staff: StaffProps[] }) => {
	const { totalPages, page, setPage, loading } = useStaff();
