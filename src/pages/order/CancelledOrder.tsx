// Documentation: This component displays a list of cancelled orders, allowing users to search, filter, export, and manage visible table columns.
...
const CancelledOrder = () => {
	...
	// Documentation: Sets the filter for cancelled orders. This effect runs only once on component mount
