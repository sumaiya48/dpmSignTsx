				...
				<div
					className={cn(
						...
						variant === "floating" || variant === "inset"
							...
							: "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=left]:border-slate-400/40 group-data-[side=right]:border-l",
						className
					)}
					{...props}
				>
	...
	return (
		<Comp
			...
			className={cn(
				...
				"data-[active=true]:bg-sidebar-primary data-[active=true]:text-white transition-all duration-300",
				size === "sm" && "text-xs",
				size === "md" && "text-sm",
				"group-data-[collapsible=icon]:hidden",
				className
